...
from miniface.modules import modeling
from miniface.models.Detector import Detector, DetectedFace, FacialAreaRegion
from miniface.commons import image_utils
...
def extract_faces(
    ...
    for face_obj in face_objs:
        ...
        # optional nose and mouth fields are coming just for retinaface
        if current_region.nose is not None:
            facial_area["nose"] = current_region.nose
        if current_region.mouth is not None:
            facial_area["mouth"] = current_region.mouth
...
def expand_and_align_face(
    ...
    if align is True:  # and left_eye is not None and right_eye is not None:
        ...
        if mouth is not None:
            mouth = (mouth[0] - width_border, mouth[1] - height_border)
